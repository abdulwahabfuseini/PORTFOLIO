...
const Contact = () => {
  return (
    ...
    <h1 className='text-2xl text-center capitalize sm:text-4xl'>CONTACT ME</h1>
    <p className="pt-4 text-xl text-center sm:text-3xl">Love to hear from you, Get in touch</p>
